				...
				<div class="row">
					<form method="POST" action="{{ route('manage-students.update', ['manage_student' => $students->student_id]) }}" enctype="multipart/form-data">
						...
						<ul class="nav nav-pills mb-3 pf1" id="pills-tab" role="tablist">
							    ...
							    <li class="nav-item" role="presentation">
							        <button class="nav-link  active mr-2 sub-btn1" id="pills-test-tab" type="button" role="tab" aria-selected="true"
...
var  firstInputBox = accordionItemHeader.nextElementSibling.querySelector("input");
